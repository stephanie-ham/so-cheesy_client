  ...
  return (
    <footer className="footer">
      <section className="footer__top">
        ...
        <Link className="footer__item link" color="inherit" to="/"><h2>LOGO</h2></Link>
        </div>
      ...
      <section className="footer__bottom">
        <div className="footer__bottom--container">
          ...
          <p className="fb__copyright">	&#169; 2021 <strong><em>Block.</em></strong> Charcuterie Maker &#160; | &#160; All Rights Reserved</p>
        </div>
      </section>
    </footer>
  )
